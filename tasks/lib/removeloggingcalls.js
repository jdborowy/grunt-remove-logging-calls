    ...
    var getSegmentsToReplace = function(nodes, namespaces, methods) {
        ...
        for (var i = 0, ii = nodes.length; i < ii; ++i) {
            ...
            if (nodes[i].type === 'CallExpression' &&
                ...
                console.log("namespaceMethod " + namespaceMethod.namespace + "." + namespaceMethod.method);
                console.log(namespaces.indexOf(namespaceMethod.namespace) + "," + methods.indexOf(namespaceMethod.method));
